...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_checkout_form.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_social_login.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" href="javascript:void(0)" class="ws-btn w3-padding w3-round">Submit</a>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_contact_form" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ...
  Full width */<br>&nbsp;&nbsp;padding: 12px; /* Some padding */&nbsp; <br>&nbsp; border: 1px solid #ccc; 
  /* Gray border */<br>&nbsp; 
  ...
  <br>/* Style the submit button with a specific background color etc */<br>input[type=submit] {<br>&nbsp;&nbsp;background-color: #04AA6D;<br>&nbsp;&nbsp;color: white;<br>&nbsp;&nbsp;padding: 12px 20px;<br>&nbsp;&nbsp;border: none;<br>
  ...
  padding around the form */<br>.container {<br>&nbsp;&nbsp;border-radius: 5px;<br>&nbsp;&nbsp;background-color: #f2f2f2;<br>&nbsp;&nbsp;padding: 20px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_contact_form" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
