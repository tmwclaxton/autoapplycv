...
<div class="w3-clear nextprev">
  ...
  <a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=forms">Next &#10095;</a>
</div>
<hr>

<p class="intro">An HTML form is used to collect user input. The user input is 
...
<div class="w3-panel ws-note"><p><b>Note:</b> The form itself is not visible. Also note that the default width 
...
the user focuses on the input element.</p>
<p>The <code class="w3-codespan">&lt;label&gt;</code> element also helps users who have 
...
<p>If the <code class="w3-codespan">name</code> attribute is omitted, the value of the input field will not be sent at all.</p>
<div class="w3-example">
<h3>Example</h3>
<p>This example will not submit the value of the &quot;First name&quot; input field:&nbsp;</p>
<div class="w3-code notranslate htmlHigh">
 &lt;form action="/action_page.php"&gt;<br>&nbsp; &lt;label for=&quot;fname&quot;&gt;First 
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML Forms</h2>
  <a href="https://youtu.be/VLeERv_dR6Q&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/22_html_forms.webp" type="image/webp" />
        <img src="images/22_html_forms.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
