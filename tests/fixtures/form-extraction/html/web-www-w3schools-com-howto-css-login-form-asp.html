...
<a class="w3-left ws-btn" href="howto_js_scroll_to_top.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_signup_form.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive login form with CSS.</p>
<hr>
<p>Click on the button to open the login form:</p>
<button onclick="document.getElementById('id01').style.display='block'" class="ws-btn w3-blue w3-padding-large">Login</button>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryhow_css_login_form_modal" class="ws-btn">Try it Yourself &raquo;</a>
</p>
...
<div class="w3-code notranslate htmlHigh">
  &lt;form action=&quot;action_page.php&quot; method=&quot;post&quot;&gt;<br>&nbsp; &lt;div class=&quot;imgcontainer&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
...
input[type=text], input[type=password] {<br>&nbsp; width: 100%;<br>&nbsp; padding: 12px 20px;<br>
  &nbsp; margin: 8px 0;<br>
  &nbsp;
display: inline-block;<br>&nbsp; border: 1px solid #ccc;<br>&nbsp; box-sizing: border-box;<br>
}<br><br>/* Set a style for all buttons */<br>button {<br>&nbsp; background-color: #04AA6D;<br>
  &nbsp; color: white;<br>&nbsp; padding: 
14px 20px;<br>&nbsp;&nbsp;margin: 8px 0;<br>&nbsp; border: none;<br>&nbsp; cursor: pointer;<br>
  &nbsp; width: 
100%;<br>}<br><br>/* Add a hover effect for buttons */<br>button:hover {<br>&nbsp;&nbsp;opacity: 0.8;<br>}<br><br>/* Extra style for the cancel button (red) */<br>.cancelbtn {<br>&nbsp;&nbsp;width: auto;<br>&nbsp;&nbsp;padding: 10px 18px;<br>
...
image */<br>img.avatar {<br>&nbsp; width: 40%;<br>
  &nbsp;
border-radius: 50%;<br>}<br><br>/* Add padding to containers */<br>.container {<br>
  &nbsp; padding: 16px;<br>}<br>
...
display: block;<br>&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp;&nbsp;}<br>&nbsp;&nbsp;.cancelbtn {<br>
  &nbsp;&nbsp;&nbsp; 
width: 100%;<br>&nbsp;&nbsp;}<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_login_form" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
#000;<br>&nbsp;&nbsp;font-size: 35px;<br>&nbsp;&nbsp;font-weight: bold;<br>}<br><br>/* 
...
&quot;none&quot;;<br>&nbsp;&nbsp;}<br>}<br>
&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_login_form_modal" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-panel ws-note">
  <p>Ever heard about <strong>W3Schools Spaces</strong>? Here you can create your website from scratch or use a template.</p>
