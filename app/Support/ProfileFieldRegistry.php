...
class ProfileFieldRegistry
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'application_settings.phone_country_code' => self::field('Phone country code', 'profile', 'field-phone-country-code', 'application_settings.phone_country_code', 'settings', ['phone country code', 'country code']),
            ...
            'application_settings.expected_salary_weekly' => self::field('Expected salary (weekly)', 'preferences', 'field-expected-salary-weekly', 'application_settings.expected_salary_weekly', 'settings', ['weekly salary', 'salary per week', 'weekly wage']),
            'application_settings.expected_salary_monthly' => self::field('Expected salary (monthly)', 'preferences', 'field-expected-salary-monthly', 'application_settings.expected_salary_monthly', 'settings', ['monthly salary', 'salary per month', 'monthly gross']),
            'application_settings.expected_salary_yearly' => self::field('Expected salary (yearly)', 'preferences', 'field-expected-salary-yearly', 'application_settings.expected_salary_yearly', 'settings', ['yearly salary', 'annual salary', 'salary per year', 'expected salary', 'salary expectation']),
            ...
            'application_settings.willing_to_relocate' => self::field('Willing to relocate', 'preferences', 'field-willing-to-relocate', 'application_settings.willing_to_relocate', 'settings', ['willing to relocate', 'open to relocation', 'available for relocation', 'relocation', 'relocate']),
    ...
    public static function resolveField(string $field): ?string
    {
        ...
        $aliases = [
            ...
            'expected_salary_weekly' => 'application_settings.expected_salary_weekly',
            'expected_salary_monthly' => 'application_settings.expected_salary_monthly',
            'expected_salary_yearly' => 'application_settings.expected_salary_yearly',
