...
use Database\Factories\AutofillSyntheticDailyStatFactory;
 ...
 */
class AutofillSyntheticDailyStat extends Model
{
    /** @use HasFactory<AutofillSyntheticDailyStatFactory> */
    use HasFactory;
